...
# ── 1. 수업 제목 ──
st.title("기체")  # ← 교과별 제목으로 자유롭게 수정하세요.
...
"""  # ← 교사가 원하는 서술형 문제로 변경
st.markdown("#### 기체입자운동 1")
st.write("기체입자운동")
answer_1 = st.text_area("모름", key="answer1", height=150)

# ── 3‑2. 서술형 문제 2 표시 ──
QUESTION_2 = """
보일의 법칙에 대해 설명하세요.
"""
st.markdown("#### 보일의 법칙 2")
st.write("보일의법칙")
answer_2 = st.text_area("모름", key="answer2", height=150)
...
st.write("열에너지이동")
answer_3 = st.text_area("모름", key="answer3", height=150)
...
# ── 1. 문항별 채점 기준 (교사가 수정) ──
GRADING_GUIDELINES = {
    1: "입자 충돌·속도 증가 예를 기술할 수 있다.",
    2: "일정한 온도에서, 기체의 압력과 부피가 서로 반비례하는 것을 알고 있다.",
    3: "복사는 전자기파를 통해 열이 이동하는 것을 알고 있다."
}
